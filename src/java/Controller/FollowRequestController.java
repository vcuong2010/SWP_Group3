 ...
 * @author TGDD
 */
@WebServlet(name="FollowRequestController", urlPatterns={"/follow"})
public class FollowRequestController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if(request.getParameter("type") != null ) {
            ...
            if(request.getParameter("type").equalsIgnoreCase("accept")) {
                try {
        ...
        try {
            ArrayList<FollowRequest> arr = FollowDAO.getRequests(u.getId());
            request.setAttribute("requests", arr);
        } catch(Exception e) {}
        request.getRequestDispatcher("follow request.jsp").forward(request, response);
    } 
