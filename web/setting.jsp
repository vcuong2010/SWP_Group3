            ...
            <header class="menu__header fix-menu" id="header-menu">
                <div class="navbar-header">
                    <a href="index" class="logo">
                        <img alt="logo playerduo" style="border-radius: 50%;" src="images/logo.png">
                    </a>
                </div>
                <div class="navbar">
                ...
                <div class="navbar-mobile hidden">
                    <ul class="navbar-nav">
                        ...
                        <li class="item-icon item-avatar dropdown">
                            <a id="header-nav-dropdown" role="button" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false" href="#">
                                <img src="<%=role != null ? (isMentor ? (((Mentor)role).getAvatar() == null ? "https://files.playerduo.net/production/images/avatar31.png" : ((Mentor)role).getAvatar()) : (((Mentee)role).getAvatar() == null ? "https://files.playerduo.net/production/images/avatar31.png" : ((Mentee)role).getAvatar())) : "https://files.playerduo.net/production/images/avatar31.png" %>" class="avt-img" style="max-height:45px; max-width: 45px" alt="PD"> </a>
                            <ul role="menu" class="dropdown-menu" aria-labelledby="header-nav-dropdown">
                                <li role="presentation" class="page-user">
                                    <a role="menuitem" tabindex="-1" href="#">
                                        <img src="<%=role != null ? (isMentor ? (((Mentor)role).getAvatar() == null ? "https://files.playerduo.net/production/images/avatar31.png" : ((Mentor)role).getAvatar()) : (((Mentee)role).getAvatar() == null ? "https://files.playerduo.net/production/images/avatar31.png" : ((Mentee)role).getAvatar())) : "https://files.playerduo.net/production/images/avatar31.png" %>" class="avt-img" style="max-height:45px; max-width: 45px" alt="PD">
                                                    ...
                                                    <div class="panel-collapse collapse in">
                                                        <div class="panel-body">
                                                            <div class="panel-group">
                                                                ...
                                                                <div class="menu__setting--last panel panel-default">
                                                                    <div class="panel-heading">
                                                                        <div class="panel-title active">Tài khoản và mật khẩu</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <form class="changepass-form row" action="setting" method="post">
                                <div class="col-md-6">
                                    <div class="fieldGroup changepass--fieldGroup">
                                        <p class="control-label">Mật khẩu cũ:</p>
                                        <input type="password" name="oldPassword" placeholder="" maxlength="5000" autocomplete="false" value="" required>
                                    </div>
                                    <div class="fieldGroup changepass--fieldGroup">
                                        <p class="control-label">Mật khẩu mới:</p>
                                        <input type="password" required name="newPassword" placeholder="" maxlength="5000" autocomplete="false" value="">
                                    </div>
                                    <div class="fieldGroup changepass--fieldGroup">
                                        <p class="control-label">Xác nhận lại mật khẩu:</p>
                                        <input required type="password" name="confirmNewPassword" placeholder="" maxlength="5000" autocomplete="false" value="">
                                    </div>
                                    <hr>
