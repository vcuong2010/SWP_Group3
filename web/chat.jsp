...
<html lang="en">
    ...
    <body style="padding-top: 66px; display:flex" >
        ...
        <!-- ======= Hero Section ======= -->
        <div class="message__popup--box-content" style="grid-template-columns: 19.5vw 1fr; height: 100%">
            <div class="box__left display" style="height: 100%">
                <div class="box__left--message">
                    <div class="list-message-content">
                        <%
                            Conversation currCon = (Conversation)request.getAttribute("currConver");
                            ArrayList<Conversation> Conversation = (ArrayList)request.getAttribute("conversation");
                            for(int i = 0; i < Conversation.size(); i++) {
                                Conversation c = Conversation.get(i);
                        %>
                        <div>
                            <div class="<%=c.getId() == currCon.getId() ? "active" : ""%> media" <%=c.getId() == currCon.getId() ? "" : "onclick=\"window.location.href='chat?id="+c.getUserID()+"'\""%>>
                                <div class="media-left">
                                    <div class="avt avt-sm">
                                        <img src="<%=c.getAvatar() != null ? c.getAvatar() : "https://files.playerduo.net/production/images/avatar7.png"%>" class="avt-img" style="width: 40px; height:40px" alt="PD">
                                        <div class="stt stt-ready"></div>
                                    </div>
                                </div>
                                <div class="media-body">
                                    <p class="name-player-review"><%=c.getFullName()%></p>
                                    <%if(c.getLastMsg() != null) {%>
                                    <p id="lastMsg-<%=c.getId()%>"><%=c.getLastMsg()%></p>
                                    <span id="lastTime-<%=c.getId()%>"><%=c.lastTimeFormat()%></span>
                                    <%}%>
                                </div>
                            </div>
                        </div>
            ...
            <div class="box__right wrapper" style="width: 80vw; height: 100%">
                <div class="box__right--header">
                    <div class="media">
                        <div class="media-left">
                            <i class="fas fa-chevron-left"></i>
                            <div class="avt avt-sm">
                                <img src="<%=currCon.getAvatar() != null ? currCon.getAvatar() : "https://files.playerduo.net/production/images/avatar7.png"%>" class="avt-img" style="width: 35px; height:35px" alt="PD">
                                <div class="stt stt-ready"></div>
                            </div>
                        </div>
                        <div class="media-body media-middle" style="max-width: 75vw;">
                            <span class="name-player-review"><%=currCon.getFullName()%></span>
                        </div>
                        <div class="pl-btn media-right media-middle">
                            <div class="dropdown btn-group btn-group-xs">
                                <button id="dropdown-no-caret" role="button" aria-haspopup="true" aria-expanded="false" type="button" class="dropdown-toggle btn btn-xs btn-default">
                                    <i class="fas fa-ellipsis-v"></i>
                                </button>
                                <ul role="menu" class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-no-caret">
                                    <li role="presentation" class="">
                                        <a role="menuitem" tabindex="-1" href="#">
                                            <i class="fas fa-trash"></i> Xoá chat </a>
                                    </li>
                                    <li role="presentation" class="">
                                        <a role="menuitem" tabindex="-1" href="#">
                                            <i class="fas fa-trash"></i> Chặn </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="box__right--message chat-main-wrap">
                    <div>
                        <div class="main-header">
                            <p class="name">
                                <span><%=currCon.getFullName()%></span>
                            </p>
                        </div>
                        <div class="main-body" style="height: 77vh">
                            <div class="mess-detail-room" style="height: 77vh !important;">
                                <i style="flex-grow: 1;"></i>
                                <div id="MessageContent">
                                    <%
                                        ArrayList<Message> msgs = (ArrayList)request.getAttribute("message");
                                        for(int i = 0; i < msgs.size(); i++) {
                                            Message m = msgs.get(i);
                                    %>
                                    <div class="msg-wrap">
                                        <div class="msg-body <%=m.getSenderID() == u.getId() ? "msg-fill" : ""%> radius">
                                            <div class="msg-detail" style="position: relative;">
                                                <div title='<%=m.sendAtFormat()%>'>
                                                    <div class="msg null">
                                                        <p><%=m.getMsgContent()%></p>
                                                    </div>
                                                </div>
                        ...
                        <div class="main-footer">
                            <div class="gif-area" style="display: none;">
                                <div class="search-gif">
                                    <span class="search room-search input-group">
                                        <input placeholder="Search for GIFs" name="searchValue" autocapitalize="none" autocomplete="off" autocorrect="off" type="text" class="form-control" value="">
                            ...
                            <span class="send-message input-group">
                                <textarea class="form-control" placeholder="Type a message ..." type="text" name="message" id="msg"></textarea>
                                <span class="input-group-addon" onclick="sendMsg()">
                                    <i class="fa fa-paper-plane"  style='color: #f0564a;' aria-hidden="true"></i>
                                </span>
                                <script>
                                    function sendMsg() {
                                        if (document.getElementById("msg").value.length > 0) {
                                            setTimeout(async () => {
                                                var body = 'cid=<%=currCon.getId()%>&sid=<%=u.getId()%>&msg=' + document.getElementById("msg").value;
                                                ...
                                                for (var i = 0; i < data.length; i++) {
                                                    document.getElementById("MessageContent").innerHTML += '<div class="msg-wrap">\n\
                                        <div class="msg-body ' + (data[i]["senderID"] == <%=u.getId()%> ? "msg-fill" : "") + ' radius">\n\
                                            <div class="msg-detail" style="position: relative;">\n\
                                                <div title="' + data[i]["sendAt"] + '">\n\
                                                    <div class="msg null">\n\
                                                        <p>' + data[i]["msgContent"] + '</p>\n\
                                                    </div>\n\
                                                </div>\n\
                                            </div>\n\
                                        </div>\n\
                                                ...
                                                MsgLen = data.length;
                                                //getCon
                                                var resp2 = await fetch("chat", {
                                                    method: "POST",
                                                    headers: {
                                                        'Content-Type': 'application/x-www-form-urlencoded'
                                                    },
                                                    body: 'sid=<%=u.getId()%>&getCon=1'
                                                });
                                                var data2 = await resp2.json();
                                                var listConver = document.getElementsByClassName("list-message-content")[0];
                                                listConver.innerHTML = "";
                                                for (var i = 0; i < data2.length; i++) {
                                                    var str = '';
                                                    str += '<div>\n\
  <div class="' + (data2[i]["id"] === <%=currCon.getId()%> ? "active" : "") + ' media" ' + (data2[i]["id"] === <%=currCon.getId()%> ? "" : 'onclick="window.location.href=\'chat?id=' + data2[i]["userID"] + '\'"') + '>\n\
    <div class="media-left">\n\
      <div class="avt avt-sm">\n\
        <img src="' + (data2[i]["avatar"] !== null ? data2[i]["avatar"] : "https://files.playerduo.net/production/images/avatar7.png") + '" class="avt-img" style="width: 40px; height:40px" alt="PD">\n\
        <div class="stt stt-ready"></div>\n\
      </div>\n\
    </div>\n\
    <div class="media-body">\n\
      <p class="name-player-review">' + data2[i]["fullName"] + '</p>'
                                                    if (data2[i]["lastMsg"]) {
                                                        str += '<p id="lastMsg-' + data2[i]["id"] + '">' + data2[i]["lastMsg"] + '</p>\n\
                                                <span id="lastTime-' + data2[i]["id"] + '" >' + data2[i]["lastTime"] + '</span>';
                                                    }
                                                    str += '\n\</div>\n\
  </div>\n\
</div>';
                                                    listConver.innerHTML += str;
                                                }
                                                document.getElementById("msg").value = '';
                                            }, 0);
                                        }
                                    }
                                    var MsgLen = <%=msgs.size()%>;
                                    setInterval(async () => {
                                        var body = 'getMsg=1&cid=<%=currCon.getId()%>';
                                        var resp = await fetch("chat", {
                                            method: "POST",
                                            headers: {
                                                'Content-Type': 'application/x-www-form-urlencoded'
                                        ...
                                        <div class="msg-body ' + (data[i]["senderID"] == <%=u.getId()%> ? "msg-fill" : "") + ' radius">\n\
                                            ...
                                            //document.getElementsByClassName("list-message-content")[0].innerHTML = "";
                                            MsgLen = data.length;
                                                //getCon
                                                var resp2 = await fetch("chat", {
                                                    method: "POST",
