                                ...
                                <script>
                                    ...
                                    %>
                                                if ((parseInt(t / 10) === (t / 10) && (t / 10) === p) || (parseInt(t / 10) !== (t / 10) && parseInt(t / 10) + 1) === p) {
                                                    str += '<tr id="<%=i+1%>"><td><%=i+1%></td><td><a href="skill?id=<%=az.get(i).getId()%>"><%=az.get(i).getName()%></a></td><td><a href="skill?id=<%=az.get(i).getId()%>"><%=az.get(i).getId()%></a></td><td><img src="<%=az.get(i).getAvatar()%>" style="width: 100px; height: 100px"></td><td><%=az.get(i).getDescription()%></td></tr>'
                                                } else {
                                                    str += '<tr id="<%=i+1%>" class="hidden"><td><%=i+1%></td><td><a href="skill?id=<%=az.get(i).getId()%>"><%=az.get(i).getName()%></a></td><td><a href="skill?id=<%=az.get(i).getId()%>"><%=az.get(i).getId()%></a></td><td><img src="<%=az.get(i).getAvatar()%>" style="width: 100px; height: 100px"></td><td><%=az.get(i).getDescription()%></td></tr>'
                                                }
                                                t++;
                                    <%}%>
                                    ...
                                    %>
                                                if ((parseInt(t / 10) === (t / 10) && (t / 10) === p) || (parseInt(t / 10) !== (t / 10) && parseInt(t / 10) + 1) === p) {
                                                    str += '<tr id=<%=i+1%>><td><%=i+1%></td><td><a href="skill?id=<%=za.get(i).getId()%>"><%=za.get(i).getName()%></a></td><td><a href="skill?id=<%=za.get(i).getId()%>"><%=za.get(i).getId()%></a></td><td><img src="<%=za.get(i).getAvatar()%>" style="width: 100px; height: 100px"></td><td><%=za.get(i).getDescription()%></td></tr>'
                                                } else {
                                                    str += '<tr id=<%=i+1%> class="hidden"><td><%=i+1%></td><td><a href="skill?id=<%=za.get(i).getId()%>"><%=za.get(i).getName()%></a></td><td><a href="skill?id=<%=za.get(i).getId()%>"><%=za.get(i).getId()%></a></td><td><img src="<%=za.get(i).getAvatar()%>" style="width: 100px; height: 100px"></td><td><%=za.get(i).getDescription()%></td></tr>'
                                                }
                                                t++;
                                    <%}%>
                                                document.querySelector("tbody").innerHTML = str;
                        ...
                        <table class="table table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th style="font-weight: bold; color: black">Skill Image</th>
                                    <th style="font-weight: bold; color: black">Skill Description</th>
                                </tr>
                            </thead>
                            <tbody>
