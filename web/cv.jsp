...
<html lang="en" translate="no">
    ...
    <body class="fixed-header" style="padding-top: 66px;">
        ...
        if(session.getAttribute("Mentee") == null) {
            ...
            CV cv = null;
            if(role != null && ((Mentor)role).getCvID() != 0) {
                cv = CvDAO.getCV(((Mentor)role).getCvID());
            }
            %>
            <div class="hidden">
                ...
                <div class="setting__main row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        <div class="aside">
                            ...
                            <form class="changepass-form row" method="post">
                                <div class="col-md-6">
                                    <div class="fieldGroup changepass--fieldGroup">
                                        <p class="control-label">Mô tả:</p>
                                        <input type="text" name="description" placeholder="" maxlength="5000" autocomplete="false" value="<%=(role == null || ((Mentor)role).getDescription() == null) ? "" : ((Mentor)role).getDescription()%>">
                                    </div>
                                    <div class="fieldGroup changepass--fieldGroup">
                                        <p class="control-label">Thành tựu:</p>
                                        <input type="text" name="achivement" placeholder="" maxlength="5000" autocomplete="false" value="<%=(role == null || ((Mentor)role).getAchivement() == null) ? "" : ((Mentor)role).getAchivement()%>">
                                    </div>
        ...
        if(cv != null) {%> 
                                <form method="post">
                                    ...
                                    <button type="submit" class="btn-update" id="<%=(role == null || ((Mentor)role).getCvID() == 0) ? "createCV" : "updateCV"%>"><%=(role == null || ((Mentor)role).getCvID() == 0) ? "Tạo CV" : "Cập Nhật CV"%> </button><%=cv != null ? "</form>" : ""%>
                            </div>
                        </div>
                    </div>
                </div>
