...
<html lang="en">
    ...
    <head>
        ...
        <title>List of follow requests</title>
    ...
    <body style="padding-top: 100px; display:flex" >
        <%ArrayList<FollowRequest> arr = (ArrayList)request.getAttribute("requests");
                        ...
                        <table class="table table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th style="font-weight: bold; color: black">Create Date</th>
                            ...
                            <tbody>
                                ...
                                <tr id='<%=i+1%>' <%=(i >= 10 ? "class=\"hidden\"" : "")%>>
                                    ...
                                    <td><%=arr.get(i).getDeadline()%></td>
                                    <td><%=arr.get(i).getStatus()%></td>
                                    <td>
                                        <a href="follow?type=accept&id=<%=arr.get(i).getId()%>" class="check" data-toggle="modal">
                                            <i class="fas fa-check" data-toggle="tooltip" title="Accept"></i>
                                        </a>
                                        <a href="follow?type=reject&id=<%=arr.get(i).getId()%>" class="delete" data-toggle="modal">
