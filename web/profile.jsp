                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12 col-xs-12 personalinfo">
                                    ...
                                    <div class="d-flex img-avatar">
                                        <img src="<%=role != null ? (isMentor ? (((Mentor)role).getAvatar() == null ? "https://files.playerduo.net/production/images/avatar31.png" : ((Mentor)role).getAvatar()) : (((Mentee)role).getAvatar() == null ? "https://files.playerduo.net/production/images/avatar31.png" : ((Mentee)role).getAvatar())) : "https://files.playerduo.net/production/images/avatar31.png" %>" class="" alt="avatar" sizes="sm"> <div class="cropimg-avatar">
                                            <button type="button">
                                    ...
                                    <form class="from-userinfo" action="profile" method="POST">
                                        <div class="fieldGroup ">
                                            ...
                                            <input type="text" name="fullname" placeholder="" maxlength="5000" autocomplete="false" value="<%=role != null ? (isMentor ? ((Mentor)role).getFullname() : ((Mentee)role).getFullname()) : ""%>">
                                        </div>
                                        <div class="fieldGroup ">
