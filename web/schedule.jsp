                                                                ...
                                                                <p>
                                                                    ...
                                                                    <span>
                                                                        ...
                                                                        <%  java.util.Date today = new java.util.Date();
                                                                            if(!((u.getRole().equalsIgnoreCase("mentor") ? s.getStatus().toLowerCase().contains("mentor confirm") : s.getStatus().toLowerCase().contains("mentee confirm")) || s.getStatus().toLowerCase().contains("done")) && today.after(s.getSlotTime())) {%>
