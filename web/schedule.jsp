                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <p>
                                                                    ...
                                                                    <a>
                                                                        <br>( <font color="<%=((u.getRole().equalsIgnoreCase("mentor") ? s.getStatus().equalsIgnoreCase("Mentor Confirmed") : s.getStatus().equalsIgnoreCase("Mentee Confirmed")) || s.getStatus().equalsIgnoreCase("Done")) ? "green" : "red"%>"><%=((u.getRole().equalsIgnoreCase("mentor") ? s.getStatus().equalsIgnoreCase("Mentor Confirmed") : s.getStatus().equalsIgnoreCase("Mentee Confirmed")) || s.getStatus().equalsIgnoreCase("Done")) ? "Done" : "Not Yet"%></font>) <br>
                                                                        <%
                                                                            Calendar c = Calendar.getInstance();
