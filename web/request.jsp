        ...
        <header class="menu__header fix-menu" id="header-menu">
            ...
            <div class="navbar">
                ...
                <ul class="nav navbar-nav navbar-center">
                    ...
                    <li class="item-icon">
                        <a class="group-user active" style="display: block" href="request">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="" id="" <%if(!arr.get(i).getStatus().equalsIgnoreCase("cancel")) {%>onclick="update<%=arr.get(i).getId()%>(event)"<%}%> class="edit" data-toggle="modal">
                                            <i class="fas fa-edit" data-toggle="tooltip" title="" title="Edit"></i>
                                        </a>
                                        <%if(!arr.get(i).getStatus().equalsIgnoreCase("cancel")) {%>
                                        <script>
                                        ...
                                        <a href="request?type=delete&id=<%=arr.get(i).getId()%>" class="delete" data-toggle="modal">
                                            <i class="fas fa-trash" data-toggle="tooltip" title="" title="Delete"></i>
                                        </a>
                                    </td>
                                </tr> 
                                <%}%>
