                                                        ...
                                                        <div class="panel-body">
                                                            <div class="panel-group">
                                                                <div class="menu__setting--last panel panel-default">
                                                                    <div class="panel-heading">
                                                                        <div class="panel-title active">Email</div>
                                                                    </div>
                                                                </div>
                                                                <div class="menu__setting--last panel panel-default">
                                                                    <div class="panel-heading">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="fieldGroup ">
                                            ...
                                            <input type="text" name="emailValue" placeholder="" maxlength="5000" autocomplete="false" value="<%=u.getEmail()%>" <%=!u.isIsValidate() ? "" : "disabled"%>>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="col-md-3">
                                            <span class="badge-email <%=!u.isIsValidate() ? "bg-email-unverified" : "bg-email-verified"%> hidden-sm hidden-xs">
                                                <i class="fa <%=!u.isIsValidate() ? "fa-ban" : "fa-check"%>"></i> <%=!u.isIsValidate() ? "Unverified" : "Verified" %> </span>
                                        </div>
                                    </div>
                                        <%if(!u.isIsValidate()) {%>
                                    <div class="col-md-6">
                                        <hr>
                                        <button type="submit" class="btn-delemail mt-3">Xác nhận email</button>
                                    </div>
                                    <%}%>
                                </div>
                                <div class=""></div>
