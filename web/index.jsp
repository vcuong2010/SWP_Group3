                                    ...
                                    <div class="player-information-card-wrap">
                                        <div class="player-avatar">
                                            <a target="_blank" href="skill?id=<%=arr.get(i).getId()%>">
                                                <img src="<%=arr.get(i).getAvatar() != null ? arr.get(i).getAvatar() : "images/no-image.jpg"%>" class="" alt="PD" id="avt-img-reponsiver">
                                            </a>
                                        </div>
                                        <a target="_blank" class="player-information" href="skill?id=<%=arr.get(i).getId()%>">
                                            <h3 class="player-name">
                                                <span style="font-weight: 700;color: #000;" target="_blank" href="skill?id=<%=arr.get(i).getId()%>"><%=arr.get(i).getName() != null ? arr.get(i).getName() : ""%> </span>
            ...
            <footer id="footer">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 footer-newsletter">
                                ...
                                <p>Happy Programming always wants you to experience the best when joining us</p>
                ...
                <div class="container d-md-flex py-4" style="
                    ...
                    <div class="me-md-auto text-center text-md-start" style="
                         ...
                         ">
                        <div class="copyright">
                            &copy; Group3-SE1756 <strong><span>Mentor</span></strong>. All Rights Reserved
                        </div>
                        <div class="credits">
                            ...
                            Designed by <a href="https://bootstrapmade.com/">Group3-SE1756</a>
                        </div>
                    </div>
                    <div class="social-links text-center text-md-right pt-3 pt-md-0">
                        <a href="https://www.facebook.com/profile.php?id=100037242873916" class="facebook"><i class="bx bxl-facebook"></i></a>
                    </div>
                </div>
            </footer><!-- End Footer -->
        </div>
